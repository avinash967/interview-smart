...
export default function Hero() {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            tl.fromTo(".hero-line",
                { y: 100, opacity: 0, rotationZ: 2 },
                { y: 0, opacity: 1, rotationZ: 0, duration: 1.2, stagger: 0.15 }
            )
        ...
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 max-w-[1200px] mx-auto mt-20">
                <h1 ref={headingRef} className="text-5xl md:text-[5.5rem] leading-[1.05] font-normal tracking-tight mb-8 w-full flex flex-col items-center">
                    <div className="overflow-hidden pb-1"><div className="hero-line text-white opacity-0">Interview Smart</div></div>
                    <div className="overflow-hidden pb-2"><div className="hero-line text-white opacity-0">With AI-Powered Insights</div></div>
                </h1>

                <p ref={textRef} className="text-neutral-400 text-lg md:text-xl font-medium max-w-3xl mb-12 tracking-wide leading-relaxed opacity-0">
                ...
                <div ref={btnRef} className="flex flex-col sm:flex-row justify-center gap-6 w-full sm:w-auto px-4 opacity-0">
