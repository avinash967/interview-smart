                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    {testimonials.map((t, i) => (
                        <motion.div
                            ...
                            className="opacity-0 p-8 md:p-10 rounded-2xl bg-neutral-900/40 border border-white/5 hover:border-white/10 transition-all flex flex-col justify-between transform-gpu backface-hidden"
                        >
