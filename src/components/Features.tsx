                ...
                <div className="grid grid-cols-1 md:grid-cols-2 auto-rows-auto gap-6 md:gap-8">
                    {features.map((feature, i) => (
                        <motion.div
                            ...
                            className={`group relative p-8 md:p-10 rounded-2xl bg-neutral-900/40 border border-white/5 hover:border-white/10 hover:bg-neutral-900/60 transition-all duration-500 hover:-translate-y-1 hover:shadow-xl ${feature.className}`}
                        >
