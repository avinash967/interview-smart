            ...
            <div className="max-w-[1200px] mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <motion.div
                        ...
                        className="opacity-0 p-8 rounded-3xl bg-neutral-900/40 border border-white/5 hover:border-white/10 transition-all flex flex-col items-start transform-gpu backface-hidden"
                    >
